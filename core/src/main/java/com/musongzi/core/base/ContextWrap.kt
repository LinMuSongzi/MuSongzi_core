...
class ContextWrap(conetxt:Context) :Context(){

    val weakReference = WeakReference(conetxt)


    override fun getAssets(): AssetManager? {
        return weakReference.get()?.assets
    }

    override fun getResources(): Resources? {
        return weakReference.get()?.resources
    }

    override fun getPackageManager(): PackageManager? {
        return weakReference.get()?.packageManager
    }
